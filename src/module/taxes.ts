...
class Taxes {
  ...
  async index({ queryParams: params, pagination }: ApiRequest<SalesInvoiceRequest, any>) {
    ...
    return this.parasut.send<SalesInvoiceResponse>('GET', `${this.parasut.options.firmaNo}/taxes`, request)
  }
  ...
  async create({ data, queryParams: params }: ApiRequest<SalesInvoiceRequest, any>) {
    ...
    return this.parasut.send<SalesInvoiceResponse>('POST', `${this.parasut.options.firmaNo}/taxes`, request)
  }
  ...
  async show(id: string, { queryParams: params }: ApiRequest<any, any>) {
    ...
    return this.parasut.send<any>('GET', `${this.parasut.options.firmaNo}/taxes/${id}`, request)
  }
  ...
  async edit(id: string, { queryParams: params }: ApiRequest<any, any>) {
    ...
    return this.parasut.send<any>('PUT', `${this.parasut.options.firmaNo}/taxes/${id}`, request)
  }
